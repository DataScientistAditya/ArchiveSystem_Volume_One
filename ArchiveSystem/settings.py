"""
Django settings for ArchiveSystem project.
...
SECRET_KEY = 'django-insecure-3ms715^r213x(unfb1+ad4-b6p!-z8#j*by4&q@(enxtg0as85'
...
ROOT_URLCONF = 'ArchiveSystem.urls'
...
WSGI_APPLICATION = 'ArchiveSystem.wsgi.application'
